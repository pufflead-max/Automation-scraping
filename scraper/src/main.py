...
Can be run standalone or called from Airflow DAGs.
"""
...
def run_nextdoor_scraper(
    ...
    Args:
        cookies: Nextdoor authentication cookies (required)
    ...
    try:
        ...
        leads = scraper.run(
            target=None,  # Nextdoor uses authenticated feed
            save_to_db=save_to_db,
            max_pages=max_pages
        )
        
        scraper_logger.info(
            "nextdoor_scraper_completed",
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Target URL or location to scrape"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Category name for the scraping job"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to JSON file containing Nextdoor authentication cookies"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Maximum number of pages to scrape (for Nextdoor)"
    )
    ...
    try:
        ...
        if args.scraper == "craigslist":
            ...
            if not cookies:
                ...
                print("  Use --nextdoor-cookies path/to/cookies.json")
                print("  See: development_pipelines/testing_nextdoor_1_jan_2026.ipynb")
                sys.exit(1)
